...
@interface AGScrollMenuView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation AGScrollMenuView

#pragma mark - Lifecycle

- (instancetype)initWithFrame:(CGRect)frame scrollTheme:(AGScrollTheme *)scrollTheme {
    ...
    if (self) {
        ...
        [self registerClass:[AGScrollMenuTitleCell class] forCellWithReuseIdentifier:kTitleCellIdentifier];
...
- (void)updateCellOfIndexPath:(NSIndexPath *)indexPath {
    ...
    AGScrollMenuTitleCell *lastCell = (AGScrollMenuTitleCell *)[self cellForItemAtIndexPath:lastIndexPath];
    lastCell.choosed = NO;
    
    AGScrollMenuTitleCell *cell = (AGScrollMenuTitleCell *)[self cellForItemAtIndexPath:indexPath];
    cell.choosed = YES;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AGScrollMenuTitleCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.scrollDelegate && [self.scrollDelegate respondsToSelector:@selector(agScrollMenuView:didSelectItemAtIndexPath:)]) {
        [self.scrollDelegate agScrollMenuView:self didSelectItemAtIndexPath:indexPath];
    }
}
...
#pragma mark - <AGScrollContentViewDelegate>
